...
public class secondpage extends AppCompatActivity {
    String[] mobileArray = {"Zara Si Dil Mein", "Love Yourself", "Mein Tenu Samjhawa", "Tum Mile", "Saibo",
            "What Makes You Beautiful","Wildest Dreams","Love Me Like You Do","Just The Way You Are","Emptiness"};
    Integer[] imgid = {
    ...
    public void OnClickButtonListner(){
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent("com.example.hp.mayyuu.shuffling");
        ...
        bu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent("com.example.hp.mayyuu.sorting");
